...
Sensor data is transmitted via MQTT to a Node.js backend server and logged to ThingSpeak for cloud analytics and historical monitoring. The system provides instant visual feedback through a local display and supports remote monitoring through a web dashboard.
...
https://smart-sports-monitor.vercel.app/

This dashboard displays real-time environmental sensor data and safety status generated by the Smart Outdoor Sports Monitor.
...
1. Connect sensors to the ESP32 according to the circuit design
